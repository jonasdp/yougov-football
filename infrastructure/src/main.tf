...
resource "aws_api_gateway_resource" "resource_team" {
  path_part   = "{name}"
  parent_id   = aws_api_gateway_resource.resource_teams.id
  rest_api_id = aws_api_gateway_rest_api.rest_api.id
}

resource "aws_api_gateway_method" "method_get" {
  rest_api_id   = aws_api_gateway_rest_api.rest_api.id
  resource_id   = aws_api_gateway_resource.resource_team.id
  http_method   = "GET"
  authorization = "NONE"
}
